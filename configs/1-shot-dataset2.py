...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=True, interval=50, max_keep_ckpts=10, type='CheckpointHook'),
...
test_evaluator = dict(
    ann_file='../data/dataset2/annotations/test.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
...
train_cfg = dict(max_epochs=500, type='EpochBasedTrainLoop', val_interval=500)
