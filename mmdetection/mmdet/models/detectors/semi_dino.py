...
from .semi_deformable_detr import SemiDeformableDETR, MultiScaleDeformableAttention


@MODELS.register_module()
class SemiDINO(SemiDeformableDETR):
    ...
    def init_weights(self) -> None:
        ...
        super(SemiDeformableDETR, self).init_weights()
